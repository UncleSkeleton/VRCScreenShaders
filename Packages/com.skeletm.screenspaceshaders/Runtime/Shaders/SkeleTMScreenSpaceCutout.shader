Shader "SkeleTM/Screen Space Cutout"
{
    Properties
    {
        _Scale("Scale", Float) = 1
        [NoScaleOffset]_Albedo("Image", 2D) = "white" {}
    ...
    SubShader
    {
        ...
        SurfaceDescription SurfaceDescriptionFunction(SurfaceDescriptionInputs IN)
        {
            ...
            half _Property_6aa65e424b4346d6b46a749f5180d364_Out_0_Float = _AlphaCutoff;
            ...
            surface.AlphaClipThreshold = _Property_6aa65e424b4346d6b46a749f5180d364_Out_0_Float;
            return surface;
        }
